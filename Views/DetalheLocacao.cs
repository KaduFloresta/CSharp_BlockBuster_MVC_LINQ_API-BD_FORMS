...
namespace Locadora_MVC_LINQ_API_BD_Interface 
{
    public class LocacaoDetalhe : Form 
    {
        ...
        public LocacaoDetalhe (Form parent, LocacaoModels Locacao) 
        {
            ...
            lbl_DataNascimento.Text = "Data de Nascimento: "; // + cliente.DataNasc;
            ...
            lbl_CpfCliente.Location = new Point (300, 190);
            ...
            lbl_IdLocacao.Text = "ID da Locação: "; // + locacao.DataLocacao.ToString();
            ...
            lbl_DataLocacao.Text = "Data da Locação: "; // + locacao.DataLocacao.ToString();
            ...
            lbl_DataDevolucao.Text = "Data de Devolução: "; // + locacao.DataDevol.ToString();
            ...
            lbl_QtdeFilmes.Text = "Quantidade de Filmes: "; // + locacao.QtdeFilmes;
            ...
            lbl_ValorTotal.Text = "Total da Locação: "; // + filme.Titulo;
            ...
            lbl_Filmes.Text = "Filmes Locados: "; // + filme.Titulo;
